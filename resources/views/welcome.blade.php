...
@section('content')
    ...
    <section class="welcome-text">
        <div class="container">
            ...
            <h1>Welcome to DC Universe Comics Shop!</h1>
            ...
            <p>
                At DC Universe Comics Shop, we pride ourselves on offering not just comics, but a gateway to extraordinary
                worlds
                where heroes rise, villains scheme, and epic battles unfold. Our passion for comics drives us to provide
                top-notch
                customer service and a curated selection that caters to both seasoned collectors and enthusiastic readers.
            </p>
